...
TEST(Command_line, command_function_not_specified)
{
  ...
  ASSERT_EQ(Command_line::ERROR_NOT_INITIALIZED, cli->add_command("test", 0));
  delete cli;
}
...
{
  Command_line *cli = new Command_line();
  ASSERT_EQ(Command_line::ERROR_NONE, cli->add_command("test", test_function));
  ASSERT_EQ(Command_line::ERROR_NOT_FOUND, cli->process_command("testy"));
  ASSERT_EQ(Command_line::ERROR_NONE, cli->process_command("test"));
  delete cli;
}
...
TEST(Command_line, trime_white_space)
{
  ...
  ASSERT_EQ(Command_line::ERROR_NONE, cli->process_command(" test "));
  ASSERT_EQ(Command_line::ERROR_NONE, cli->process_command("\ttest\t"));
  ASSERT_EQ(Command_line::ERROR_NONE, cli->process_command("\ntest\n"));
  ASSERT_EQ(Command_line::ERROR_NONE, cli->process_command("\rtest\r"));
  ASSERT_EQ(Command_line::ERROR_NONE, cli->process_command("\vtest\v"));
  ASSERT_EQ(Command_line::ERROR_NONE, cli->process_command("\ftest\f"));
  delete cli;
}
...
TEST(Command_line, arc_argv_arguments)
{
  Command_line *cli = new Command_line();
  ASSERT_EQ(Command_line::ERROR_NONE, cli->add_command("test", test_function));
  ASSERT_EQ(Command_line::ERROR_NONE, cli->process_command(argc, argv));
